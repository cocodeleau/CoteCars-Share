    ...
    <div className="hero-estimator">
      ...
      {state === 'results' && vehicle && results && (
        <div className="hero-estimator-results">
          ...
          <button className="btn btn-ghost btn-sm" style={{ width: '100%', marginTop: 8 }} onClick={() => navigate('/pro/dashboard')}>
      ...
      <div className="faq-inner">
        <div className="faq-left">
          ...
          <div className="faq-help-card">
            ...
            <button className="btn faq-help-btn" onClick={() => navigate('/pro/dashboard')}>Créer un compte gratuit</button>
          </div>
        </div>
    ...
    <div>
      <nav className="landing-nav">
        ...
        <div className="nav-cta">
          ...
          <button className="btn btn-ghost btn-sm" onClick={() => navigate('/')}>Vous êtes un particulier ?</button>
          <button className="btn btn-primary btn-sm" onClick={() => navigate('/pro/dashboard')}>Mon espace →</button>
        </div>
      </nav>
      ...
      <div className="cta-banner">
        ...
        <div className="cta-banner-btns">
          <button className="btn btn-primary btn-lg" onClick={() => navigate('/pro/dashboard')}>
