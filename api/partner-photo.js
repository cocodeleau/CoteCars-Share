...
// gemini-1.5-flash : pas de "thinking tokens", output JSON complet et fiable
...
//
// Modèle : gemini-1.5-flash (pas de "thinking tokens" → réponse JSON complète)
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // ── 1. Gemini Vision ────────────────────────────────────────────────────
    console.log("[Pipeline] Étape 1 — Gemini Vision (gemini-1.5-flash)...");
